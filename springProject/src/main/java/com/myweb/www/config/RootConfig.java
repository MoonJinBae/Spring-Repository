...
@EnableAspectJAutoProxy // 트렌젝션 처리용
@EnableTransactionManagement // 트렌젝션 처리용
@EnableScheduling
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		hikariCongig.setJdbcUrl("jdbc:log4jdbc:mysql://localhost:3306/springdb"); // mysql database 경로 / database이름
		hikariCongig.setUsername("springUser"); // mysql user ID
		hikariCongig.setPassword("mysql"); // PW
